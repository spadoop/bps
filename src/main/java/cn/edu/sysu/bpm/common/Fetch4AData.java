...
import cn.edu.sysu.bpm.common.vo.User;
...
//		if ("role".equals(typeCode))return new WFParticipant();
		...
		if (typeCode.equals(ROLE)) {
			sql = ConnectManager.SQLManager.getSql("roleAll");
		} else if (typeCode.equals(ORGANIZATION)) {
			sql = ConnectManager.SQLManager.getSql("orgAll");
		} else if (typeCode.equals(PERSON)) {
			sql = ConnectManager.SQLManager.getSql("personAll");
		} else if (typeCode.equals(POSITION)) {
			sql = ConnectManager.SQLManager.getSql("positionAll");
		}
...
//		if("organization".equals(typeCode)){
		...
		if (typeCode.equals(ROLE)) {
			...
			sql = ConnectManager.SQLManager.getSql("orgRoot");
		} else if (typeCode.equals(PERSON)) {
			sql = ConnectManager.SQLManager.getSql("personAll");
		} else if (typeCode.equals(POSITION)) {
			sql = ConnectManager.SQLManager.getSql("positionAll");
...
//							participantID);
					sql = ConnectManager.SQLManager.getSql("roleUser");
//					param.put(1, participantID);
				}
				else if (childType.equals(ORGANIZATION)){
//					sql = String.format(SQLManager.getSql("roleOrg"), 
//							participantID);
					sql = ConnectManager.SQLManager.getSql("roleOrg");
//					param.put(1, participantID);
				}
				else if (childType.equals(POSITION)){
//					sql = String.format(SQLManager.getSql("rolePosition"),
//							participantID);
					sql = ConnectManager.SQLManager.getSql("rolePosition");
//					param.put(1, participantID);
...
//							participantID);
					sql = ConnectManager.SQLManager.getSql("orgChild");
//					param.put(1, participantID);
				}
...
//							participantID, 
//							participantID);
					sql = ConnectManager.SQLManager.getSql("orgUser");
					param.put(1, participantID);
...
//							participantID);
					sql = ConnectManager.SQLManager.getSql("orgRole");
//					param.put(1, participantID);
				}
				else if (childType.equals(POSITION)){
//					sql = String.format(SQLManager.getSql("orgPosition"),
//							participantID);
					sql = ConnectManager.SQLManager.getSql("orgPosition");
//					param.put(1, participantID);
...
//							participantID);
					sql = ConnectManager.SQLManager.getSql("positionUser");
					param.put(1, participantID);
				}
			}
		}
...
//							participantID);
					sql = ConnectManager.SQLManager.getSql("orgParent");
					param.put(1, participantID);
...
//							participantID);
					sql = ConnectManager.SQLManager.getSql("userrole");
//					param.put(1, participantID);
//					l.addAll(_execute(sql));
					l.addAll(_execute2(sql, param));
				}
...
//							participantID);
					sql = ConnectManager.SQLManager.getSql("userOrg");
					param.put(1, participantID);
//					l.addAll(_execute(sql));
					l.addAll(_execute2(sql, param));
				}
				else if (childType.equals(POSITION)) {// 获取人员岗位
//					sql = String.format(SQLManager.getSql("userPosition"),
//							participantID);
					sql = ConnectManager.SQLManager.getSql("userPosition");
//					param.put(1, participantID);
//					l.addAll(_execute(sql));
					l.addAll(_execute2(sql, param));
				}
...
//			}
			...
			String sql = ConnectManager.SQLManager.getSql("userScope");
...
//			l.addAll(_execute(sql));
			...
			//在没有本身用户的情况下也要加进来
			if(l.size() == 0){
				l.add(new WFParticipant(participantID, "", PERSON));
			}
