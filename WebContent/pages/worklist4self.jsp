                  ...
                  <table border="0" class="EOS_table" width="100%">
					...
					<c:forEach items="${tasklist}" var="task">
	                    <tr class="EOS_table_row" onmouseover="this.className='EOS_table_selectRow'" onmouseout="this.className='EOS_table_row'">
	                      	...
	                      	<td nowrap><a class="link" title='PI_${task.processInstID}|AI_${task.activityInstID}|WI_${task.workItemID}' href='javascript:doGoto("${task.processInstID}")'> ${task.workItemName}</a></td>
