...
<html>
<head>
<title><bc:message key='myTask.HelpTask'/></title>
...
function init() {				
	...
	document.getElementById('buttonOK').onclick = function () {
		...
		if(names[0].value == ""){
			alert("<bc:message key='myTask.SetHelper'/>");
		 	return;
		}
...
<table width="497" border="0" cellspacing="0" cellpadding="0" class="EOS_panel_body" height="100%">
  <tr>
    <td class="EOS_panel_head" valign="middle" colspan="2"><bc:message key='myTask.SetHelpTask'/></td>
  </tr>
  <tr>
    <td class="EOS_table_row" nowrap="nowrap" width="15%">&nbsp;&nbsp;<bc:message key='myTask.Helper'/>:</td>
  ...
  <tr>
    <td class="EOS_table_row" nowrap="nowrap" valign="top" width="15%">&nbsp;&nbsp;<bc:message key='myTask.HelperReason'/>:</td>
